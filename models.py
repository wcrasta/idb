...
class Game(db.Model):
    ...
    reviews = db.relationship('Reviews', backref='game', lazy="joined")
...
class Platform(db.Model):
    ...
    name = db.Column(db.String(80))
    summary = db.Column(db.Text)
    games = db.relationship('Game', backref='platform', lazy="joined")
    review = db.relationship('Reviews', backref='platform', lazy="joined")
...
class Studio(db.Model):
    ...
    game = db.relationship('Game', backref = 'studio', lazy= "joined")
    created_at = db.Column(db.DateTime)
