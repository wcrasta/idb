...
def orSearch(items):
    ...
    return [list(gameResults)[0:399],list(platformResults)[0:399], list(studioResults)[0:399], list(reviewsResults)[0:399]]
...
def andSearch(items):
    ...
    return [gameResults[0:399],platformResults[0:399], studioResults[0:399],reviewsResults[0:399]]
